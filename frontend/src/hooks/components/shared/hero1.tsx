            ...
            <section className=' flex flex-col gap-14'>
                ...
                <div className='flex justify-center items-center '>
                    <Link href={"/join-community"}>
                        <button
                            className="flex lg:py-3 xl:py-4 py-3 xl:text-2xl lg:text-xl text-xl xl:px-8 lg:px-6 px-5 font-mulish font-bold bg-[#C9A74E] rounded-full justify-center items-center gap-5"
                        >
                            Join Aprisio
