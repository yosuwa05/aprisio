  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-4">
        ...
        <p className="text-gray-600 mb-4">Effective Date: 03/01/2025</p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            User Services - Our Platform also allows users to showcase their
            profiles, work experience and qualifications to offer their
            expertise and professional service to other users of the Platform.
            These services may be either free or paid as per the discretion of
            the user offering the service. If the service is paid, the payment
            has to be processed through the platform’s payment gateway. The
            terms & conditions for such services are set by the user offering
            the service. Users availing the service must review these terms
            carefully before opting to use the service. If the terms &
            conditions are not explicitly stated, the user seeking the service
            should contact the user offering the Service through the Platform to
            clarify any queries or concerns. Please note that the Platform is
            not responsible and/or liable for any misrepresentation,
            non-delivery, or deficiency in the delivery of these services. It’s
            the responsibility of the user availing the service to ensure that
            adequate precautions and measures are taken to ensure satisfactory
        ...
        <p className="mb-4">
          We also offer subscription to specific products, services and
          solutions to our users. These subscription services are governed by
        ...
        <ul className="list-disc list-inside mb-4">
          <li>
            Any Fees towards ‘User Services’ may or may not be refundable
            depending on the terms & conditions of the user offering the
            service. Please verify and confirm the same with the user offering
            the service.
          </li>
          <li>
          ...
          <li>
            Any Fees paid towards ‘Subscriptions’ will be refundable on a pro
            rata basis for the unused period of the subscription.
          </li>
        </ul>
