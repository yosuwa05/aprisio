...
import { MyProfilePayments } from "@/components/my-profile/tabsection/my-profile-payment";
...
export default function MyProfile({
  ...
  return (
    <div className=''>
          ...
          <div className='flex flex-col gap-4'>
            <div className=' shadow-xl rounded-xl p-4'>
              ...
              <div className='mt-12 flex flex-col gap-3 items-center border-b pb-4'>
                <h1 className='font-semibold text-xl  md:text-2xl text-textcol capitalize text-center text-wrap whitespace-pre-wrap overflow-hidden overflow-ellipsis max-w-[280px]'>
                  {data?.user?.name}
                </h1>
      ...
      <Dialog open={chatOpen} modal={true} onOpenChange={isChatOpen}>
        <DialogContent className='h-screen border-2'>
          <VisuallyHidden>
            <DialogHeader>
