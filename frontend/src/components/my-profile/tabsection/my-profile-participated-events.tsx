...
import { EventCard } from "../my-profile-event-card";
import GlobalLoader from "@/components/globalloader";

export function MyProfileParticipatedEvents() {
    ...
    useInfiniteQuery({
      ...
      queryFn: async ({ pageParam = 1 }) => {
        const res = await _axios.get(
          `/myprofile/participated-events/?userId=${user?.id}&page=${pageParam}&limit=${limit}`
        );
        return res?.data;
      },
      initialPageParam: 1,
