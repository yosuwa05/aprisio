  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="absolute hidden -top-12 -right-12 lg:block">
        <div
          className={`rounded-full z-10 bg-[#F0B73FE3] ${
      ...
      <div className="absolute hidden -top-12 -right-12 lg:block">
        <div
          className={`rounded-full z-10 bg-[#F0B73FB2] ${
      ...
      <div className="absolute hidden -top-12 -right-12 lg:block">
        <div
          className={`rounded-full z-10 bg-[#F0B73F] ${
      ...
      <div className="text-white absolute flex lg:justify-start justify-center lg:top-16 top-10 xl:left-16 lg:left-9 lg:px-10 px-4">
        ...
        >
          ...
          connected, fulfilling and impactful life.
        </h1>
      </div>
      ...
      <div className="absolute inset-0 flex xl:top-52 lg:top-44 xl:left-24 lg:left-14 md:-top-[40%] -top-0 items-center justify-center lg:justify-start">
        <Link href={"/join-community"}>
          <span className="flex font-mulish lg:px-6 px-4 py-3 lg:py-4 xl:text-2xl lg:text-xl  text-lg font-bold bg-[#F0B73F] hover:bg-[#f8cd71] hover:border-[#eba50d] hover:border-[5px] rounded-full justify-center items-center gap-5 transition-all duration-300">
            Join the Community
            <span className="text-white bg-[#00000029] rounded-full p-1">
              <RiArrowRightLine
                className={`${isZoomedOut ? "w-5 h-5" : "w-6 h-6"}`}
              />
            </span>
          </span>
        </Link>
