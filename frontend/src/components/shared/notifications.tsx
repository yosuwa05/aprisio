            ...
            data?.pages?.flatMap((page) =>
              page?.notifications?.map((notification: any) => (
                <div
                  ...
                  className={`flex items-start border-[1px] border-slate-100 gap-6 cursor-pointer p-3 rounded-lg transition-colors ${notification.read ? "bg-background hover:bg-muted/50" : "bg-muted/50 hover:bg-muted"}`}
                >
