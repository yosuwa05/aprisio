        ...
        <div className="absolute top-0">
          <div
            className={`flex flex-col ${
              isZoomedOut ? "pt-20" : "pt-10"
            }  md:h-screen  justify-start items-center `}
          >
            <div className="flex flex-col justify-center items-center w-[90%]">
              <h1
                className={`font-semibold  ${
                  isZoomedOut ? "xl:text-[66px]" : "xl:text-[66px]"
                } lg:text-[45px] md:text-[32px] text-[24px]  text-[#353535] text-center font-roboto`}
              >
                Your career may be behind you.
              </h1>
              <h2 className="font-semibold xl:text-[52px] lg:text-[40px] md:text-[24px] text-[18px] text-[#353535] text-center mt-5 lg:mt-5 font-roboto">
