  ...
  return (
    <nav className="w-full flex px-2 my-2 justify-between md:px-8">
      ...
      <div className="flex gap-2 items-center px-2">
        ...
        <Button
          variant={"ghost"}
          className="border-[1px] bg-contrastbg lg:hidden rounded-lg border-[#E2E2E2] w-[25px] h-[35px] md:w-[35px] md:h-[35px]"
        >
        ...
        <Button
          variant={"ghost"}
          className="border-[1px] bg-contrastbg p-0 rounded-lg border-[#E2E2E2] w-[35px] h-[35px] md:w-[35px] md:h-[35px]"
        >
          <Bell />
        </Button>
